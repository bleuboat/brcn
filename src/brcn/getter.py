...
def get() -> None:
    ...
    with sync_playwright() as p:
        ...
        go(page, "https://backrooms-wiki-cn.wikidot.com/fragment:bleuboat")
        ...
        for p in range(int(n)):
            if p > 0:
                go(page, f"https://backrooms-wiki-cn.wikidot.com/fragment:bleuboat/p/{p + 1}")
            for div in page.locator("#page-content .list-pages-item").all():
                ...
                go(page2, f"https://backrooms-wiki-cn.wikidot.com/{data["fullname"]}/norender/true")
